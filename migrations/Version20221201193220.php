...
final class Version20221201193220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE congressus_user_informations_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE congressus_user_informations (id INT NOT NULL, congressus_user_id INT NOT NULL, username VARCHAR(255) DEFAULT NULL, first_name VARCHAR(255) DEFAULT NULL, primary_last_name_prefix VARCHAR(255) DEFAULT NULL, primary_last_name VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, iban VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('ALTER TABLE users ADD congressus_user_informations_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE congressus_user_informations_id_seq CASCADE');
        $this->addSql('DROP TABLE congressus_user_informations');
        $this->addSql('DROP INDEX IDX_1483A5E9355EDACC');
        $this->addSql('ALTER TABLE "users" DROP congressus_user_informations_id');
